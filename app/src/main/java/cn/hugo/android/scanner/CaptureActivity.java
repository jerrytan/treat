...
import com.tan.dnatreatment.activity.UpdateBarcodeActivity;
...
//				Toast.LENGTH_SHORT).show();
		...
		final String scanResult = ResultParser.parseResult(rawResult).toString();
		dialog.setMessage("条形码扫描成功，结果为"+scanResult );
		dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				finish();
				Intent newIntent = new Intent(mContext, UpdateBarcodeActivity.class);
				newIntent.putExtra("barcode",scanResult);
